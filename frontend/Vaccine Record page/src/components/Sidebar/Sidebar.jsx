...
const SidebarVaccine = () => {
    return (
        <>
            ...
            <aside id="sidebar-multi-level-sidebar" className="top-20 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                    ...
                    <ul className="space-y-2 font-medium">
                        <li>
                            ...
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <Link
                                    to="/vaccination-center/vaccine-register"
                                    className="flex items-center p-2 hover:bg-gray-200 rounded-lg"
                                >
                                    <span className="ms-3">Vaccination Registration</span>
                                </Link>
                            </a>
                        ...
                        <li>
                            <button type="button" className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                                ...
                                <Link
                                    to="/vaccination-center/schedule-viewer"
                                    className="flex items-center p-2 hover:bg-gray-200 rounded-lg"
                                >
                                    <span className="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Update Vaccine</span>
                                </Link>
                        ...
                        <li>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <Link
                                    to="/vaccination-center/vaccine-add"
                                    className="flex items-center p-2 hover:bg-gray-200 rounded-lg"
                                >
                                    <span className="flex-1 ms-3 whitespace-nowrap">Vaccine Add</span>
                                </Link>
                            </a>
                        </li>
                    </ul>
